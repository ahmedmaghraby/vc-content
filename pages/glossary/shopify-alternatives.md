...
<div class="glosary" itemscope itemtype="http://schema.org/Article">
    ...
    <div class="glosary-nav">
        <a href="/glossary/magento-alternatives" class="btn btn--orange">Prev</a>
        <a href="/glossary/nopcommerce-alternative" class="btn btn--orange">Next</a>
    </div>
    <div class="responsive">
        <div class="glosary-article">
            {% include 'disqus' %}

        ...
        <div class="row list list--cards">
            <div class="list__item col-md-6">
                <div class="list__inner">
                    <div class="list__img">
                        <img src="../../assets/images/what-is-b2b-ecommerce.jpg" alt="" class="list__pic">
                    </div>
                    <div class="list__t">What is business to business e commerce? B2B ecommerce examples</div>
                    ...
                    <a class="btn btn--orange btn--round" href="{{ '/glossary/what-is-b2b-ecommerce' | absolute_url }}">Read more...</a>
                </div>
            </div>
            <div class="list__item col-md-6">
                <div class="list__inner">
                    <div class="list__img">
                        <img src="../../assets/images/blog/b2b-online-aftermath1.jpg" alt="" class="list__pic">
                    </div>
                    <div class="list__t">B2B Online Aftermath</div>
                    <div class="list__descr">
            ...
            <div class="list__item col-md-6">
                <div class="list__inner">
                    ...
                    <div class="list__t">Top B2B e commerce sites and companies</div>
                    <div class="list__descr">
                    ...
                    <a class="btn btn--orange btn--round" href="{{ '/glossary/b2b-ecommerce-companies-websites' | absolute_url }}">Read more...</a>
                </div>
            </div>
        </div>
    </div>
    <div class="blog" style="background: #fff; padding: 0; padding-bottom: 40px;">
        ...
        <div class="row list list--cards">
            <div class="list__item col-md-6">
                <div class="list__inner">
                    <div class="list__img">
                        <img src="../../assets/images/blog/b2becommerce.jpg" alt="" class="list__pic">
                    </div>
                    <div class="list__t">Top 5 B2B ecommerce challenges and solutins</div>
                    <div class="list__descr">
                    ...
                    <a class="btn btn--orange btn--round" href="{{ '/blog/top5-b2b-ecommerce-challenges' | absolute_url}}">Read more...</a>
                </div>
            </div>
            <div class="list__item col-md-6">
                <div class="list__inner">
                    <div class="list__img">
                        <img src="../../assets/images/blog/b2b-b2c-difference.png" alt="" class="list__pic">
                    </div>
                    <div class="list__t">Difference between B2B and B2C ecommerce solution</div>
                    <div class="list__descr">
                    ...
                    <a class="btn btn--orange btn--round" href="{{ '/blog/difference-between-b2b-and-b2c-ecommerce-solution' | absolute_url }}">Read more...</a>
                </div>
            </div>
            <div class="list__item col-md-6">
                <div class="list__inner">
                    <div class="list__img">
                        <img src="../../assets/images/blog/B2B-Online-Aftermath.jpg" alt="" class="list__pic">
                    </div>
                    <div class="list__t">B2B Online Aftermath</a></div>
                    <div class="list__descr">
